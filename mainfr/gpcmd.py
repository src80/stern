from otherfs.rank import setrank,isrank,remrank,remsudos,setsudo, GPranks,Grank,IDrank,isrankDef,remasudo
from otherfs.tg import Bot , Ckuser
from otherfs.send import send_msg, BYusers, Name,Gcommands,sendM,getAge
from otherfs.locks import st,Ccommands,st_res
from config import *
...
<a href=\"https://t.me/Ha_ssin/\">hassan</a>
[hassan](https://t.me/Ha_ssin/)
...
#cre
    if rank != "admin" and rank != "owner":
      ...
      # if re.search(c.Chcommands, text):
      #   Bot("sendMessage",{"chat_id":chatID,"text":r.Chcommands,"reply_to_message_id":message.id,"parse_mode":"html","reply_markup":Ccommands(client, message,redis,r)})
