from otherfs.rank import setrank,isrank,remrank,remsudos,setsudo, GPranks
from otherfs.send import send_msg, BYusers,Name,Gcommands
from otherfs.locks import st
