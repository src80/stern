...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس", url="t.me/GO_XXO")],[InlineKeyboardButton("بوت التواصل", url="t.me/Tawasel_Hassan_1998_bot")],[InlineKeyboardButton("مجموعة السورس", url="t.me/almohajrina_walansar")]])
