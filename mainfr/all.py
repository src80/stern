...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس ", url="t.me/ald_source")],[InlineKeyboardButton("تواصل السورس ", url="t.me/TW_HBOT")],[InlineKeyboardButton("مجموعة السورس ", url="t.me/almohajrina_walansar")]])
