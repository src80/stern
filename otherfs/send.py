...
def Gcommands(redis,chatID):
  if redis.sismember("{}Nbot:commands:ar".format(BOT_ID),chatID):
    commands = "ar"
  elif redis.sismember("{}Nbot:commands:en".format(BOT_ID),chatID):
    commands = "en"
  elif redis.sismember("{}Nbot:commands:arem".format(BOT_ID),chatID):
    commands = "arem"
  else :
    commands = "arem"
  return commands
